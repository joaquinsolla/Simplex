  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: HomeArea(null, PageHeader(context, 'Nuevo evento'), FooterEmpty(),
          [
            FormSwitchButton('Una vez', 'Rutina', isOneTimeEvent, (){
              setState(() {
            ...
            FormSeparator(),
            FormContainer([
              if(isOneTimeEvent) FormDateTimeSelector(
                  dateController,
                  'Fecha:',
                  dateHintText,
                  dateFocusNode,
            ...
            if(isOneTimeEvent) FormSeparator(),
            if(isOneTimeEvent) FormContainer([
              Text(
                'Notificaciones:',
                style: TextStyle(
                    color: colorMainText,
